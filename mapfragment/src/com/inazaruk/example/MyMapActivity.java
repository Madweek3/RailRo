...
import com.nhn.android.mapviewer.NMapCalloutCustomOverlayView;
...
import com.nhn.android.mapviewer.NMapViewer.MapContainerView;
...
public class MyMapActivity  extends NMapActivity{  /*  extends MapActivity { */
	...
	private static final String API_KEY = "a769b04527757379879f118bd4b48e22";
		...
		if (mMyLocationOverlay != null) {
			...
			if (mMapLocationManager.isMyLocationEnabled()) {
				...
				if (!isMyLocationEnabled) {
					Toast.makeText(MyMapActivity.this, "Please enable a My Location source in system settings",
	...
	private NMapPathDataOverlay pathDataOverlay = null;
	...
	Runnable runnablePath = new Runnable() {
		...
		public void run() {
			...
			pathData2.addPathPoint(127.106279, lastlatitude, NMapPathLineStyle.TYPE_DASH);
			
			lastlatitude += 0.0001f;
			
			pathData2.addPathPoint(127.106279, lastlatitude, 0);
			...
			pathLineStyle.setPataDataType(NMapPathLineStyle.TYPE_DASH);
			pathLineStyle.setLineColor(color, 0xff);
			pathLineStyle.setFillColor(color , 0x00);
			pathData2.setPathLineStyle(pathLineStyle);
			Random r = new Random();
			color =  r.nextInt(16777215);
			mMapView.postInvalidate();
			myHandler.postDelayed( runnablePath , 1000);
		}
	};
	...
	private void testPathDataOverlay() {
		...
		pathData.addPathPoint(127.105933, 37.365621, NMapPathLineStyle.TYPE_SOLID);
		...
		if (pathDataOverlay != null) {
			...
			pathData2.initPathData();
			pathData2.addPathPoint(127.106279, 37.366380, NMapPathLineStyle.TYPE_SOLID);
			pathData2.addPathPoint(127.106279, 37.3664, 0);
			pathData2.addPathPoint(127.106279, 37.3665, 0);
			pathData2.addPathPoint(127.106279, 37.3666, 0);
			
			lastlatitude = 37.3666f;
	...
	private final NMapActivity.OnDataProviderListener onDataProviderListener = new NMapActivity.OnDataProviderListener() {
		...
		public void onReverseGeocoderResponse(NMapPlacemark placeMark, NMapError errInfo) {
			...
			if (errInfo != null) {
				...
				Toast.makeText(MyMapActivity.this, errInfo.toString(), Toast.LENGTH_LONG).show();
				return;
			}
	...
	private final NMapLocationManager.OnLocationChangeListener onMyLocationChangeListener = new NMapLocationManager.OnLocationChangeListener() {
		...
		public void onLocationUpdateTimeout(NMapLocationManager locationManager) {
			...
			Toast.makeText(MyMapActivity.this, "Your current location is temporarily unavailable.", Toast.LENGTH_LONG).show();
		}

		@Override
		public void onLocationUnavailableArea(NMapLocationManager locationManager, NGeoPoint myLocation) {

			Toast.makeText(MyMapActivity.this, "Your current location is unavailable area.", Toast.LENGTH_LONG).show();
	...
	private final NMapView.OnMapStateChangeListener onMapViewStateChangeListener = new NMapView.OnMapStateChangeListener() {
		...
		public void onMapInitHandler(NMapView mapView, NMapError errorInfo) {
			...
			if (errorInfo == null) { // success
				...
				Toast.makeText(MyMapActivity.this, errorInfo.toString(), Toast.LENGTH_LONG).show();
			}
		}
	...
	private final NMapPOIdataOverlay.OnStateChangeListener onPOIdataStateChangeListener = new NMapPOIdataOverlay.OnStateChangeListener() {
		...
		public void onCalloutClick(NMapPOIdataOverlay poiDataOverlay, NMapPOIitem item) {
			...
			Toast.makeText(MyMapActivity.this, "onCalloutClick: " + item.getTitle(), Toast.LENGTH_LONG).show();
		}
			...
			if (itemOverlay instanceof NMapPOIdataOverlay) {
				...
				if (!poiDataOverlay.isFocusedBySelectItem()) {
					...
					if (countOfOverlappedItems > 1) {
						...
						Toast.makeText(MyMapActivity.this, text, Toast.LENGTH_LONG).show();
						return null;
					}
				}
			}
		...
		public View onCreateCalloutOverlayView(NMapOverlay itemOverlay, NMapOverlayItem overlayItem, Rect itemBounds) {
			...
			if (overlayItem != null) {
				...
				if (title != null && title.length() > 5) {
					return new NMapCalloutCustomOverlayView(MyMapActivity.this, itemOverlay, overlayItem, itemBounds);
				}
			}
	...
	Handler mylocHanlder = new Handler();
	
	Runnable  mylocRunnable = new Runnable() {
		...
		public void run() {
			...
			mylocHanlder.postDelayed(mylocRunnable, 4000);
